...
const links = [
  ...
  { to: '/admin/nutritionists', icon: '✔️', label: 'Approve Nutritionists' },
  { to: '/admin/subscriptions', icon: '💳', label: 'Manage Payments' },
  { to: '/admin/blog', icon: '📝', label: 'Manage Blog' },
  { to: '/admin/inquiries', icon: '📬', label: 'Handle Inquiries' },
]
