...
const links = [
  ...
  { to: '/dashboard/plan', icon: '📋', label: 'My Plan' },
  { to: '/dashboard/book', icon: '🗓️', label: 'Book Consultation' },
  { to: '/dashboard/tracker', icon: '📊', label: 'Food Tracker' },
  { to: '/dashboard/log', icon: '📈', label: 'My Progress' },
